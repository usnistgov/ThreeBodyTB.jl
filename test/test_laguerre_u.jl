...
#              push!(kpoints, zeros(1,3))
          ...
          newdatabase = ThreeBodyTB.FitTB.do_fitting_recursive(tbc_list, fit_threebody=false, fit_threebody_onsite=false, do_plot=false, fit_umat = false, lambda = 1e-5, starting_database = database_start);          
          ...
          for c in [c1,c2,c3,c4,c5,c6,c7,c8,c1a,c3a,c5a,c7a,c8a,c9a]
              ...
              en, tbc, flag = scf_energy(tbc , mix = 0.05, iters = 300)
              push!(EN_OLD, en)
          end
          newdatabaseU = ThreeBodyTB.FitTB.do_fitting_recursive(tbc_list_new, fit_threebody=false, fit_threebody_onsite=false, do_plot=false, fit_umat = true, lambda = 1e-5);          
          
          EN_TEST = []

#          newdatabaseU[(:H, :H)].datU = [10.0, 10.0]
          for c in [c1,c2,c3,c4,c5,c6,c7,c8,c1a,c3a,c5a,c7a,c8a,c9a]
