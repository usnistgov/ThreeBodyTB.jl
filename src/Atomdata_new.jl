...
#atoms["Is"] = makeatom("Si", 14, 3, 4, 28.09,  4.0,   0,   [:s, :p], -9.15243175, [-10.6594, -3.9477],0.007075865418, 0.5300262399999837);
    ...
    atoms["H" ] = makeatom("H" , 1, 1, 1, 1.0079,   1.0,   0,   [:s ],     -0.90531367, [-0.46533567834863526], 0.0, 0.8735850194157434, adj= 15.56325018071482 );
...
#    atoms["Si"] = makeatom("Si", 14, 3, 4, 28.09,  4.0,   0,   [:s, :p], -9.15243181, [-0.7914241887679531; -0.2981179964824184],0.0, 0.448871 , adj= 124.19186186707114,  fullU=true, Uarr = [0.7, 0.6103690583467152, 0.5612372485699727] .- 0.11236606932674417);
    ...
    #atoms["Si"] = makeatom("Si", 14, 3, 4, 28.09,  4.0,   0,   [:s, :p], -9.15243181, [-0.7914241887679531; -0.2981179964824184],0.0, 0.5153893492781636 , adj= 124.19186186707114,  fullU=true, Uarr = [0.5588627009143179, 0.494456270072509, 0.484159638112117]);
    #    atoms["Si"] = makeatom("Si", 14, 3, 4, 28.09,  4.0,   0,   [:s, :p], -9.15243181, [-0.7914241887679531; -0.2981179964824184],0.0, 0.5153893492781636 , adj= 124.19186186707114,  fullU=true, Uarr = [0.6136192085203853, 0.5549127499209454, 0.5246441365890315]);
        atoms["Si"] = makeatom("Si", 14, 3, 4, 28.09,  4.0,   0,   [:s, :p], -9.15243181, [-0.7914241887679531; -0.2981179964824184],0.0, 0.5153893492781636 , adj= 124.19186186707114,  fullU=true, Uarr = [0.6136600978061556, 0.5548878193364295, 0.5238623754203515]);
...
data_temp["H"] =  [0.8735850194157434, 9.001264819834413]
...
#data_temp["Si"] =  [0.5153893492781636, 49.4688470496161]
#data_temp["Si"] =  [0.5153893492781636, 102.55657885565321]
data_temp["Si"] =  [0.5481674747002284, 102.63362273877829]
...
function prepare_atom(A, U, uni)    
    ...
    if String(A) == "Si"
        println("uniform_charge_interaction $uni !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!")
    end
end
